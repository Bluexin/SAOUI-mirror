...
public enum SAOColor {
    ...
    DEAD_COLOR(0x0033ccFF),
    HARDCORE_DEAD_COLOR(0xC94141FF);
    ...
    public int multiplyAlpha(float alpha) {
        return SAOColor.multiplyAlpha(this.rgba, alpha);
    }

    public int mediumColor(SAOColor color) {
        return this.mediumColor(color.rgba);
    }

    public int mediumColor(int rgba) {
        return SAOColor.mediumColor(this.rgba, rgba);
    }
